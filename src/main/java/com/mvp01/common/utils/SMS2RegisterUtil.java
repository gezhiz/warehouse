 ...
 */
public class SMS2RegisterUtil implements Runnable {
        ...
        if (StringUtils.isNotBlank(mobilePhone)) {
            ...
            if (!StringUtils.isBlank(SMSCode)) {
                if (StringUtils.isBlank(getSMSDesc())) {
                    content = String.format("您的密码是：%s，请使用本手机号登录http://www.linktal.com，如有问题直接联系销售。", SMSCode);
                } else {
    ...
    public static void main (String[] args) {
        SMS2RegisterUtil sms2Util = new SMS2RegisterUtil();
